...
public class SendMail {
	...
	public static void sendMail(final String from, final String password, String[] to, String[] cc)
...
*/
	...
	//	formatter = new SimpleDateFormat("dd MMMM yyyy");
		...
		//	message.setContent(messageBodyPart, "text/html; charset=utf-8");
			messageBodyPart.setText("Mr Recipient,"
					+ "\n \n      Testing activity of Automation testing with attached test-data is completed."
					...
					+ "<font color=red>This is system generated E-mail, please do not reply to this E-mail..!</font>");
